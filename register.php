            ...
            <div class="login-box ptb--100">
                <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="POST">
                    <div class="login-form-head">
                        <h4>Sign up</h4>
                        <p>Hello there, Sign up and Join </p>
                    </div>
                    <br>
                    <?php echo"$success";?>
                    <?php echo"$fail";?>
                    ...
                    <?php echo"$first_name_err";?>
                        <div class="form-gp">
                            ...
                            <input type="text" id="fisrt_name" name="first_name" required>
                            <i class="ti-user"></i>
                    ...
                    <div class="form-gp">
                        ...
                        <label for="wallet">Username</label>
                        <input type="text" id="wallet" name="username" required >
                        <i class="ti-money"></i>
                        <div class="text-danger"></div>
                    </div>
                    ...
                    <div class="form-gp">
                      ...
                      <label for="code">Referal's code</label>
